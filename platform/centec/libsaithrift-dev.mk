...
ifeq ($(SAITHRIFT_V2),y)
$(LIBSAITHRIFT_DEV)_DEPENDS += $(LIBTHRIFT_0_14_1) $(LIBTHRIFT_0_14_1_DEV) $(PYTHON3_THRIFT_0_14_1) $(THRIFT_0_14_1_COMPILER) $(LIBNL3_DEV) $(LIBNL_GENL3_DEV)
$(LIBSAITHRIFT_DEV)_RDEPENDS += $(LIBTHRIFT_0_14_1) $(LIBNL3_DEV) $(LIBNL_GENL3_DEV)
$(LIBSAITHRIFT_DEV)_BUILD_ENV = SAITHRIFTV2=true SAITHRIFT_VER=v2 GEN_SAIRPC_OPTS="--adapter_logger"
else
$(LIBSAITHRIFT_DEV)_DEPENDS += $(LIBTHRIFT) $(LIBTHRIFT_DEV) $(PYTHON_THRIFT) $(THRIFT_COMPILER) $(LIBNL3_DEV) $(LIBNL_GENL3_DEV)
$(LIBSAITHRIFT_DEV)_RDEPENDS += $(LIBTHRIFT) $(LIBNL3_DEV) $(LIBNL_GENL3_DEV)
endif
$(LIBSAITHRIFT_DEV)_DEPENDS += $(CENTEC_SAI) $(CENTEC_SAI_DEV)
$(LIBSAITHRIFT_DEV)_RDEPENDS += $(CENTEC_SAI)
